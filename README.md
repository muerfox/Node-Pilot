...
The backend suite (157 tests) runs against SQLite with a faked Redis (no
...
schedules), and snapshot create/rollback/delete (including a failed
...
a 147 KB gzipped bundle (noVNC accounts for most of that). 228
